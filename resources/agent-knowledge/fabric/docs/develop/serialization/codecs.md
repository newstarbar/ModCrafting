...
```java
// region encode_blockpos[Java] not found — showing file head
...
```
// missing reference: reference/latest/src/main/generated/reports/example-mod/codec_examples/serialize_blockpos.json[Output]
```
...
```java
// region list_codec[Codec] not found — showing file head
package com.example.docs.datagen;
...
```java
// region list_codec_data[Input] not found — showing file head
package com.example.docs.datagen;
...
```
// missing reference: reference/latest/src/main/generated/reports/example-mod/codec_examples/list_codec.json[Output]
```
...
```java
// region bean_codec[Codec] not found — showing file head
...
```java
// region bean_codec_data[Input] not found — showing file head
package com.example.docs.datagen;
...
```
// missing reference: reference/latest/src/main/generated/reports/example-mod/codec_examples/cool_beans.json[Output]
```
...
```java
// region optional_field[Codec] not found — showing file head
package com.example.docs.datagen;
...
```java
// region optional_field_data[Input] not found — showing file head
package com.example.docs.datagen;
...
```
// missing reference: reference/latest/src/main/generated/reports/example-mod/codec_examples/optional_field.json[Output]
```
...
```java
// region default_field[Codec] not found — showing file head
package com.example.docs.datagen;
...
```java
// region default_field_data[Input] not found — showing file head
package com.example.docs.datagen;
...
```
// missing reference: reference/latest/src/main/generated/reports/example-mod/codec_examples/default_field.json[Output]
```
...
```java
// region unit_codec[Codec] not found — showing file head
package com.example.docs.datagen;
...
```
// missing reference: reference/latest/src/main/generated/reports/example-mod/codec_examples/unit.json[Output]
```
...
```java
// region numeric_range[Codec] not found — showing file head
package com.example.docs.datagen;
...
```java
// region numeric_range_data[Input] not found — showing file head
package com.example.docs.datagen;
...
```
// missing reference: reference/latest/src/main/generated/reports/example-mod/codec_examples/numeric_range.json[Output]
```
...
```java
// region pair_codec[Codec] not found — showing file head
package com.example.docs.datagen;
...
```java
// region pair_codec_data[Input] not found — showing file head
package com.example.docs.datagen;
...
```
// missing reference: reference/latest/src/main/generated/reports/example-mod/codec_examples/pair.json[Output]
```
...
```java
// region map_codec[Codec] not found — showing file head
package com.example.docs.datagen;
...
```java
// region map_codec_data[Input] not found — showing file head
package com.example.docs.datagen;
...
```
// missing reference: reference/latest/src/main/generated/reports/example-mod/codec_examples/map.json[Output]
```
...
```java
// region convert_xmap[Codec] not found — showing file head
package com.example.docs.datagen;
...
```java
// region convert_xmap_data[Input] not found — showing file head
package com.example.docs.datagen;
...
```
// missing reference: reference/latest/src/main/generated/reports/example-mod/codec_examples/xmap.json[Output]
```
...
```java
// region registry_dispatch[Codec] not found — showing file head
package com.example.docs.datagen;
...
```java
// region bean_interface[Bean] not found — showing file head
package com.example.docs.codec;
...
```java
// region bean_type_record[BeanType] not found — showing file head
package com.example.docs.codec;
...
```java
// region stringy_bean_class[StringyBean] not found — showing file head
package com.example.docs.codec;
...
```java
// region counting_bean_class[CountingBean] not found — showing file head
package com.example.docs.codec;
...
```java
// region bean_types_class[BeanTypes] not found — showing file head
package com.example.docs.codec;
...
```java
// region recursive_codec[Codec] not found — showing file head
package com.example.docs.datagen;
...
```java
// region recursive_codec_data[Input] not found — showing file head
package com.example.docs.datagen;
...
```
// missing reference: reference/latest/src/main/generated/reports/example-mod/codec_examples/recursive.json[Output]
```
