...
```
// region interface_injection_example_entry{classtweaker:no-line-numbers} not found — showing file head
classTweaker v2 official

# Access widening examples
# The targets for these examples are non-transitive versions of Fabric API access wideners for 26.1

# #region accesswidening_examples_classes
...
# #endregion accesswidening_examples_classes

# #region accesswidening_examples_methods
...
# #endregion accesswidening_examples_methods


# #region accesswidening_examples_fields
...
# #endregion accesswidening_examples_fields


# Interface injection example
# #region interface_injection_example_entry
inject-interface  net/minecraft/world/level/material/FlowingFluid  com/example/docs/interface_injection/BucketEmptySoundGetter
# #endregion interface_injection_example_entry

# #region interface_injection_generic_interface_entry
inject-interface  net/minecraft/world/level/material/FlowingFluid  com/example/docs/interface_injection/GenericInterface<+Ljava/lang/String;[Ljava/lang/Boolean;>
# #endregion interface_injection_generic_interface_entry


# Enum extension examples

# #region enum_extension_no_impls_example_entry
extend-enum  net/minecraft/world/inventory/RecipeBookType  EXAMPLE_MOD_RECIPE_BOOK_TYPE
# #endregion enum_extension_no_impls_example_entry
```
...
```
// region interface_injection_generic_interface_entry{classtweaker:no-line-numbers} not found — showing file head
classTweaker v2 official
