...
```java
// region custom_sound_instance not found — showing file head
...
```java
// region dynamic_sound_source not found — showing file head
...
```java
// region transition_state not found — showing file head
package com.example.docs.sound;
...
```java
// region sound_instance_callback not found — showing file head
package com.example.docs.sound.instance;
...
```java
// region class_fields not found — showing file head
package com.example.docs.sound;
...
```java
// region constructor not found — showing file head
package com.example.docs.sound;
...
```java
// region can_start not found — showing file head
package com.example.docs.sound;
...
```java
// region tick not found — showing file head
package com.example.docs.sound;
...
```java
// region modulation not found — showing file head
package com.example.docs.sound;
...
```java
// region other not found — showing file head
package com.example.docs.sound;
...
```java
// region engine_sound_instance not found — showing file head
package com.example.docs.sound.instance;
...
```java
// region sound_manager_structure not found — showing file head
package com.example.docs.sound;
...
```java
// region sound_manager_methods not found — showing file head
package com.example.docs.sound;
