# first block
> 来源: https://docs.fabricmc.net/zh_cn/develop/blocks/first-block

# 创建你的第一个方块 26.1.2 ​

学习如何在 Minecraft 中创建你的第一个自定义方块。
...
你可以重启游戏，或者在构建模组后按下 F3 + T 来应用更改——这样你就能看到方块在创造模式物品栏以及统计信息界面等地方显示名称了。

#

# 模型和纹理 ​

所有方块纹理都可以在 `assets/example-mod/textures/block` 文件夹中找到——“Condensed Dirt”方块的示例纹理可以自由使用。 [下载 纹理](/assets/develop/blocks/first_block_1_small.png)
...
重启游戏，或者按下 F3 + T 重新加载资源文件以应用更改——你应该能看到方块在物品栏内的纹理，以及在世界中呈现：
...
对战利品表的更深入理解，可参考 [Minecraft Wiki - 战利品表](https://zh.minecraft.wiki/w/%E6%88%98%E5%88%A9%E5%93%81%E8%A1%A8)页面。
