# first item
> 来源: https://docs.fabricmc.net/zh_cn/develop/items/first-item

# 创建你的第一个物品 26.1.2 ​

学习如何注册简单的物品，以及如何给物品添加纹理、模型和名称。
...
例如，将示例纹理用于 `suspicious_substance.png`。 [下载 纹理](/assets/develop/items/first_item_1_small.png)
...
- `model`：这是包含对我们模型的引用的属性。 `type`：这是模型的类型。 对于大多数物品，应该为 `minecraft:model`
