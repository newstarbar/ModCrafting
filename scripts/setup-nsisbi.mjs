 ...
 * Downloads once (via ghfast mirror), verifies sha512, and extracts to build/nsisbi/.
 */
...
const archivePath = join(root, 'build', 'nsisbi-electronbuilder-3.10.3.7z')
const extractDir = join(root, 'build', 'nsisbi')
...
async function main() {
  ...
  console.log('[nsisbi] extracting to build/nsisbi…')
